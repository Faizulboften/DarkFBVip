...
logo = """
\033[31;1m_____            _     
\033[31;1m|  __ \          | |            \033[32;1mDarkVip 8.9
\033[31;1m| |  | |_ __ __ _| | __         \033[32;1Fevloper : Faizul
\033[31;1m| |  | | '__/ _` | |/ / 
\033[31;1m| |__| | | | (_| |   <  
\033[31;1m|_____/|_|_ \__,_|_|\_\ 
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mMohon Bersabar \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
print  """ 
  ...
  \033[32;1m/ /|_/ / ___/                
 \033[32;1m/ /  / / /                    
\033[32;1m/_/__/_/_/  __                 
\033[32;1m/__  /_  __/ /___  ____  ____ _
\033[32;1m/ / / / / / __ \/ __ \/ __ `/
\033[32;1m/ / /_/ / / /_/ / / / / /_/ / 
\033[32;1m/_/\__,_/_/\____/_/ /_/\__, /  
                     \033[32;1m/____/"""
                     
jalan("Assalamullaikum wr wb Welcom to Di Dark Vip")
jalan("🔴Informasi Buat Kalian Yang menggunakan Tools ini")
jalan("Jika Kaliam mau retas Akun seseorang Anda pikirkan dulu baik baik")
jalan("Inggat setiap perbuatan pasti ada balasanya")
jalan("wkwkwkw Maaf canda Doang")
jalan("🔴NOTE KALO MAU LOGIN DONWLOAD DULU APK VPN")
jalan("KONEK OE SERVER BRAZILIA/UKRAINA")
jalan("LOH MIN KO HRUS PAKE VPN")
jalan("BIAR GAK SESI AKUN LU NJING")
jalan("\033[32;1m═══════════════════════════════════════════════")
...
def login():
  os.system('clear')
	...
	menu() 
		...
		print('          \033[1;97m[◉] \x1b[32;1mLogin Login Akun \033[1;97m[◉]' )
		id = raw_input('          \033[1;97m[◉] \033[32;1mID/Email \x1b[1;91m: \x1b[1;92m')
		pwd = raw_input('          \033[1;97m[◉] \033[32;1mPassword \x1b[1;91m: \x1b[1;92m')
		tik()
		try:
...
def super():
	...
	os.system('clear')
  print log
  print "\033[31;1m[1] \033[32;1mHack Frends List"
  print "\033[31;1m[2] \033[32;1mHack Publik Id"
  print "\033[31;1m[3] \033[32;1mHack Grub Id"
  print "\033[31;1m[4] \033[32;1mHack Target"
  print "\033[31;1m[5] \033[32;1mForm File"
  print "\033[31;1m[0] \033[31;1mKeluar"
  pilih_super()
  ...
  print "\033[1;31;48m●💋══════════════════◄►══════════════════💋●"
	...
	jalan('                    \033[1;97mMr Julong Star Hacking...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
